   ...
   <form method="post" action="crud.php?acao=inserir" name="dados" onSubmit="return enviardados();">
      ...
      <table width="588" border="0" align="center">
         ...
         <tr>
            ...
            <td width="460">
               <input name="name" type="text" class="formbutton" id="nome" size="52" maxlength="150">
            </td>
         </tr>
         ...
         <tr>
            ...
            <td>
               <font size="2">
                  <input name="date" type="date" id="data" class="formbutton">
               </font>
            </td>
         </tr>
         ...
         <tr>
            ...
            <td rowspan="2">
               <font size="2">
                  <textarea name="message" cols="50" rows="8" class="formbutton" id="mensagem" input></textarea>
               </font>
            </td>
         </tr>
         <tr>
         ...
         <tr>
            ...
            <td>
               ...
               <button class="waves-effect waves-light btn" type="submit" name="action" formaction="crud.php?acao=selecionar">ler
               </button>
               <button class="waves-effect waves-light btn" type="submit" name="action" formaction="deletar.php">excluir
               </button>
